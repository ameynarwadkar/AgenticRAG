...
- OpenAI/Anthropic/AzureOpenAI API keys for LLM
...
class Settings(BaseSettings):
    ...
    # OpenAI Configuration (optional if using Azure/Anthropic)
    ...
    azure_openai_embedding_deployment_name: str = Field(default="", env="AZURE_OPENAI_EMBEDDING_DEPLOYMENT_NAME")
